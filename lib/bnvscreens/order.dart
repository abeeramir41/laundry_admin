...
import 'package:laundry_admin/model/orderdetails.dart';
                ...
                return  Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Row(
                        children: [
                           Container( width:MediaQuery.of(context).size.width*0.12, height:  MediaQuery.of(context).size.height*0.12,
                               decoration: BoxDecoration(
