...
import 'package:laundry_admin/menuitemsadd/adddryCleaningmenu.dart';
...
class Dryitemtomenu extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _DryitemtomenuState() ;
  }

}
class _DryitemtomenuState  extends State<Dryitemtomenu >{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar:  AppBar(
          ...
          title: Text("Add Dry Clean Menu Item",style: TextStyle(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: (){
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) =>Adddryleanmenu()));
        },
