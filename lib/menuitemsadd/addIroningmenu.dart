...
class Addironmenu extends StatefulWidget {
  @override
  _AddironmenuState createState() => _AddironmenuState();
}

class _AddironmenuState  extends State<Addironmenu > {
      ...
      appBar: AppBar(
          ...
          leading:  IconButton(icon: Icon(Icons.chevron_left,color: Colors.black,),onPressed: (){
            Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                    builder: (context) =>Ironitemtomenu()));
          },),
          title: Text("Add Ironing Menu Items",style: TextStyle(
  ...
  void signIn(BuildContext context) async {
    ...
    firestoreInstance.collection("ironingitemtomenu").document(no).setData({
