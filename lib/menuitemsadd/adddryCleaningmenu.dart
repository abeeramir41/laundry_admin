...
class Adddryleanmenu extends StatefulWidget {
  @override
  _AdddryleanmenuState createState() => _AdddryleanmenuState();
}

class _AdddryleanmenuState  extends State<Adddryleanmenu > {
      ...
      appBar: AppBar(
          ...
          leading:  IconButton(icon: Icon(Icons.chevron_left,color: Colors.black,),onPressed: (){
            Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                    builder: (context) =>Dryitemtomenu()));
          },),
          title: Text("Add Dry Clean Menu Items",style: TextStyle(
  ...
  void signIn(BuildContext context) async {
    ...
    firestoreInstance.collection("drycleaningitemtomenu").document(no).setData({
