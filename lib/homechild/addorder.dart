...
import 'package:laundry_admin/model/product.dart';
import 'package:laundry_admin/screens/bnvmain.dart';
import 'package:laundry_admin/model/washingmodel.dart';
...
class _AddOrderState extends State<AddOrder>{
                            ...
                            onPressed:(){
                              setState(() {
                               ...
                               if(items[index].qty>=1){
                                 addlist(items[index].image, items[index].name, 'Wash & Ironing', items[index].qty, items[index].qty);
                               }
                              });
                            },
  ...
  void addlist(String image,String name,String title,int qty,int price ){
    var addtx=Wash(image: image,parentcatrgory: title,qty: qty,name: name,price: price );
